...
public class DeliveryCreate extends AppCompatActivity {
    TextView labelDelivery; //Delivery Man 유형을 위한 계정생성 UI임을 나타냄
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        labelDelivery = findViewById(R.id.labelDelivery); //xml에서 textView 형태 최상단 문자열의 아이디도 labelDelivery라고 가정
